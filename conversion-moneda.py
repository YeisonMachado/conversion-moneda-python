...
tipo_cambio_usd_a_mxn = 20.70 # En un caso más realista habría que consumir información actualizada de una BDD o API
...
if tipo_conversion.upper() == "EUR":
    ...
    print("No está disponible este tipo de conversión actuamente")
